        ...
        <motion.div className="relative rounded-xl bg-sky-400/20 backdrop-blur-xl border border-blue-400/30 shadow-lg cursor-grab active:cursor-grabbing">
          <div className="flex items-center -space-x-2 px-3 py-2">
            {mediaItems.map((item, index) => (
              ...
              >
                <MediaItemRenderer item={item} className="w-full h-full" onClick={() => setSelectedItem(item)} />
...
export default function InteractiveBentoGallery({ mediaItems }: InteractiveBentoGalleryProps) {
